// public/news-admin.js (整合後完整版 v3 - 加入 Debug 區塊並移除時間欄位)
document.addEventListener('DOMContentLoaded', async () => {
    ...
    [addModal, editModal].forEach(modal => {
        if (modal) {
            ...
            const cancelBtn = modal.querySelector('.action-btn.cancel-btn');
            if (cancelBtn) {
